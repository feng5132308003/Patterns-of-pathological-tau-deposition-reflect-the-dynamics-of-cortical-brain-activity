...
[r,p]=corr(tau_cross,num_pg_both_regr_fd,'rows','pairwise')%,'type','spearman'
ax=subplot(231),
plot(tau_cross,num_pg_both_regr_fd,'.','MarkerSize',20,'MarkerEdgeColor',color_pos),
...
[r,p]=corr(tau_cross_s1,num_pg_both_regr_fd_s1,'rows','pairwise')%,'type','spearman'
ax=subplot(235),
plot(tau_cross_s1,num_pg_both_regr_fd_s1,'.','MarkerSize',20,'MarkerEdgeColor',color_s1)
title([num2str(r),' p=',num2str(p)])
h2 = lsline(ax);
h2.LineWidth = 3;
h2.Color = color_s1;
