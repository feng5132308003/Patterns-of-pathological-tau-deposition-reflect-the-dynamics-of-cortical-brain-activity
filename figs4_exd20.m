...
[r,p]=corr(tau_cross_neg,num_pg_both_regr_fd_neg,'rows','pairwise')%,'type','spearman'
ax=subplot(241),
plot(tau_cross_neg,num_pg_both_regr_fd_neg,'.','MarkerSize',20,'MarkerEdgeColor',color_neg),
...
[r,p]=corr(tau_cross_pos,num_pg_both_regr_fd_pos,'rows','pairwise')%,'type','spearman'
ax=subplot(242),
plot(tau_cross_pos,num_pg_both_regr_fd_pos,'.','MarkerSize',20,'MarkerEdgeColor',color_pos),
title([num2str(r),' p=',num2str(p)])
h2 = lsline(ax);
h2.LineWidth = 3;
h2.Color = color_pos;
...
[r,p]=corr(tau_cross_s2,num_pg_both_regr_fd_s2,'rows','pairwise')%,'type','spearman'
ax=subplot(243),
plot(tau_cross_s2,num_pg_both_regr_fd_s2,'.','MarkerSize',20,'MarkerEdgeColor',color_s2)
title([num2str(r),' p=',num2str(p)])
h2 = lsline(ax);
h2.LineWidth = 3;
h2.Color = color_s2,
...
[r,p]=corr(tau_cross_s3,num_pg_both_regr_fd_s3,'rows','pairwise')%,'type','spearman'
ax=subplot(244),
plot(tau_cross_s3,num_pg_both_regr_fd_s3,'.','MarkerSize',20,'MarkerEdgeColor',color_s3)
title([num2str(r),' p=',num2str(p)])
h2 = lsline(ax);
h2.LineWidth = 3;
h2.Color = color_s3,
...
%%
[r,p]=corr(moca_ppg_neg,num_pg_both_regr_fd_neg,'rows','pairwise')%,'type','spearman'
ax=subplot(245),
plot(moca_ppg_neg,num_pg_both_regr_fd_neg,'.','MarkerSize',20,'MarkerEdgeColor',color_neg),
title([num2str(r),' p=',num2str(p)])
h2 = lsline(ax);
h2.LineWidth = 3;
h2.Color = color_neg;
...
[r,p]=corr(moca_ppg_pos,num_pg_both_regr_fd_pos,'rows','pairwise')%,'type','spearman'
ax=subplot(246),
plot(moca_ppg_pos,num_pg_both_regr_fd_pos,'.','MarkerSize',20,'MarkerEdgeColor',color_pos),
title([num2str(r),' p=',num2str(p)])
h2 = lsline(ax);
h2.LineWidth = 3;
h2.Color = color_pos;
...
[r,p]=corr(moca_ppg_s2,num_pg_both_regr_fd_s2,'rows','pairwise')%,'type','spearman'
ax=subplot(247),
plot(moca_ppg_s2,num_pg_both_regr_fd_s2,'.','MarkerSize',20,'MarkerEdgeColor',color_s2)
title([num2str(r),' p=',num2str(p)])
h2 = lsline(ax);
h2.LineWidth = 3;
h2.Color = color_s2,
...
[r,p]=corr(moca_ppg_s3,num_pg_both_regr_fd_s3,'rows','pairwise')%,'type','spearman'
ax=subplot(248),
plot(moca_ppg_s3,num_pg_both_regr_fd_s3,'.','MarkerSize',20,'MarkerEdgeColor',color_s3)
title([num2str(r),' p=',num2str(p)])
h2 = lsline(ax);
h2.LineWidth = 3;
h2.Color = color_s3,
